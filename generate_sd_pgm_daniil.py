...
path = "data/"
file = "nf1_central_hmdna_all_binary.csv"
df = pd.read_csv(path + file)

# Split train and test
df_train, df_test = train_test_split(df, test_size=0.2, shuffle=True, random_state=42, stratify=df['label'])
...
synthetic_train.to_csv(path+"nf1_central_hmdna_all_binary_SYN.csv", index=False)
